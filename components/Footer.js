        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/5 space-y-4">
            ...
            <div className="pt-2 space-y-1 text-[12px]">
              ...
              <Link href="/not-found">
                <span className="hover:text-white cursor-pointer block transition-colors">
                  Community
                </span>
              </Link>
            </div>
              ...
              {socialMedia.map((social, index) => {
                ...
                return (
                  <LinkComponent
                    ...
                    {...linkProps}
                  >
                    <div className="group flex items-center gap-2 text-[12px] hover:text-white transition-colors cursor-pointer">
                      <social.icon 
                        size={16} 
