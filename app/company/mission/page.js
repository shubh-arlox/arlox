...
const ArloxVisionMission = () => {
  ...
  if (!mounted) {
    return (
      <div className={`w-full ${neuBg} min-h-screen flex items-center justify-center`}>
        <div className="text-slate-600 text-xl font-semibold animate-pulse">Loading Vision...</div>
      </div>
    );
  }
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8 mb-12 sm:mb-16">
            ...
            >
              <motion.div 
                ...
                whileHover={{ scale: 1.02 }}
              >
                <div className="relative h-64 sm:h-80 md:h-96 lg:h-[400px] rounded-xl sm:rounded-2xl overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                  <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-8">
                    <div className="text-center">
                      ...
                      <p className="font-semibold text-base sm:text-lg" style={{ color: colors.slate }}>Who We Are Image</p>
                      <p className="text-xs sm:text-sm text-slate-500 mt-1 sm:mt-2">Team / Culture / Values</p>
                    </div>
                  </div>
                </div>
            ...
            {[
              {
                ...
                desc: "No-compromise standards that consistently surpass expectations",
                color: colors.navy
              },
              {
                icon: <Heart size={28} />,
                ...
                title: "Calm & Joyful",
                desc: "Never in hurry but completely relaxed—finishing ahead of schedule",
                color: colors.purple
              },
              {
                icon: <Target size={28} />,
                ...
                desc: "Focus over frenzy. Straightforwardness and candor above all.",
                color: colors.teal
              },
            ].map((item, i) => (
              <motion.div
